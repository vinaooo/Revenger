...
/**
 * Evento unificado de navegação que representa todas as ações possíveis
 * nos menus, independente da fonte de entrada (gamepad, touch, teclado).
 * 
 * Todos os adaptadores de entrada traduzem suas entradas específicas
 * para estes eventos NavigationEvent, permitindo que o NavigationController
 * processe todas as entradas de forma uniforme.
 */
 ...
 * 
 * Usado para logging, debugging e possíveis ajustes de comportamento
 * específicos por tipo de entrada (ex: delay touch diferente de gamepad).
 */
