 ...
 * ControllerInput2
 * 
 * Handler de input simplificado para RetroMenu2.
 * Design Philosophy: Apenas detecta inputs e notifica callbacks - sem lógica de estado complexa.
 * 
 * Responsabilidades:
...
class ControllerInput2(private val config: RetroMenu2Config) {
    ...
    /**
     * Notifica que o menu foi aberto.
     * Bloqueia todos os inputs para o core do emulador.
     */
    fun menuOpened() {
        isMenuOpen = true
        pressedKeys.clear()
    ...
    /**
     * Notifica que o menu foi fechado.
     * Inicia bloqueio temporário de 500ms para o botão START.
     */
    fun menuClosed() {
        isMenuOpen = false
        pressedKeys.clear()
     ...
     * Retorna true se o evento deve ser bloqueado (não passar para o core).
     */
    ...
    /**
     * Processa MotionEvent do analog stick.
    ...
    /**
     * Processa Event do RadialGamePad.
     * Retorna true se o evento deve ser bloqueado.
     */
    ...
    private fun processMenuButton(keyCode: Int) {
        ...
        val isConfirmButton = if (config.swapAB) {
