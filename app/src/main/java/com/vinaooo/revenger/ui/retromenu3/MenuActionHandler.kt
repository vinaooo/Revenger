...
class MenuActionHandler(
    ...
    private fun executeContinue() {
        ...
        android.util.Log.d("MenuActionHandler", "🔥 [EXECUTE_CONTINUE] Calling dismissMenuPublic()")
        ...
        android.util.Log.d(
                "MenuActionHandler",
                "🔥 [EXECUTE_CONTINUE] clearControllerInputState() completed"
        )
    ...
    private fun executeReset() {
        android.util.Log.d("MenuActionHandler", "🔥 [EXECUTE_RESET] ===== STARTING RESET =====")
        android.util.Log.d(
                "MenuActionHandler",
        ...
        android.util.Log.d("MenuActionHandler", "🔥 [EXECUTE_RESET] Calling dismissMenuPublic()")
        // Close menu first using the public method
        (fragment as? RetroMenu3Fragment)?.dismissMenuPublic()
        android.util.Log.d("MenuActionHandler", "🔥 [EXECUTE_RESET] dismissMenuPublic() completed")
        ...
        android.util.Log.d("MenuActionHandler", "🔥 [EXECUTE_RESET] Calling resetGameCentralized()")
        ...
        android.util.Log.d("MenuActionHandler", "🔥 [EXECUTE_RESET] ===== RESET COMPLETED =====")
        android.util.Log.d(
                "MenuActionHandler",
    ...
    private fun executeSaveLog() {
        ...
        fragment.lifecycleScope.launch {
            try {
                ...
                if (filePath != null) {
                    MenuLogger.action("✅ Log file saved successfully: $filePath")
