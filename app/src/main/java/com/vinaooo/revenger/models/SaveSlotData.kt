 ...
 *
 * Part of the multi-slot save system that supports 9 independent save slots
...
data class SaveSlotData(
     ...
     * Shows "Empty" for empty slots, otherwise the user-defined name.
     */
    ...
    /**
     * Returns formatted timestamp for display (dd/MM/yyyy HH:mm).
