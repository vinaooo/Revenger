 ...
 * 
 * Traduz eventos de gamepad (KeyEvents com keycodes de gamepad)
 * em NavigationEvents unificados.
 * 
 * Suporta:
...
class GamepadInputAdapter : InputTranslator {
    ...
    override fun translate(input: Any): List<NavigationEvent> {
        ...
        val inputSource = if (isPhysicalGamepad(input)) {
     ...
     * 
     * Gamepad físico tem source = SOURCE_GAMEPAD ou SOURCE_JOYSTICK
     * Gamepad emulado vem com source = SOURCE_KEYBOARD ou SOURCE_UNKNOWN
     */
