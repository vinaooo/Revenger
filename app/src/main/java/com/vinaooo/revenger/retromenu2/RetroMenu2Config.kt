 ...
 * RetroMenu2Config
 * 
 * Helper class para ler e gerenciar configurações do RetroMenu2 a partir de XML.
 * Todas as configurações visuais, comportamentais e de texto são centralizadas aqui.
 * 
...
class RetroMenu2Config(private val context: Context) {
    ...
    val arcadaFont: Typeface?
        get() = try {
            ...
            android.util.Log.e("RetroMenu2Config", "Erro ao carregar fonte Arcada: ${e.message}")
