...
data class DefaultSettingsProfile(
    ...
    val confEnablePip: Boolean,
    val confOrientation: String,
    ...
    companion object {
        ...
        fun fromJson(json: JSONObject): DefaultSettingsProfile {
            ...
            return DefaultSettingsProfile(
                ...
                confFullscreen = json.getBoolean("fullscreen"),                confEnablePip = json.optBoolean("enable_pip", true),                confOrientation = json.getString("orientation"),
