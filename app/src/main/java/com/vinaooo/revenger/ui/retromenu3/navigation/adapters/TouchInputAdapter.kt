 ...
 */
class TouchInputAdapter(private val viewIndexMapper: (View) -> Int) : InputTranslator {
    ...
    override fun translate(input: Any): List<NavigationEvent> {
        ...
        val selectEvent = NavigationEvent.SelectItem(index = index, inputSource = InputSource.TOUCH)
    ...
    fun createActivateEvent(): NavigationEvent {
        return NavigationEvent.ActivateSelected(inputSource = InputSource.TOUCH)
    }
