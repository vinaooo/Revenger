 ...
 * 
 * Representa todos os menus disponíveis na aplicação.
 * Cada menu tem um tipo único que identifica qual fragmento mostrar.
 */
enum class MenuType {
 ...
 * 
 * Contém toda informação necessária para restaurar um menu
 * exatamente como estava, incluindo após rotação da tela.
 * 
 ...
 * 
 * Usado para implementar navegação "para trás" (back navigation).
 * Quando o usuário navega para um submenu, o estado atual é empilhado.
 * Quando o usuário volta, o estado é desempilhado e restaurado.
 * 
 * Exemplo:
 * ```
